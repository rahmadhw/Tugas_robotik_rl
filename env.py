...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 6, 0, anchor='nw', image=self.obstacle12_object)
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(pixels * 9, pixels * 3, anchor='nw', image=self.obstacle9_object)
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 8, pixels, anchor='nw', image=self.obstacle10_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 3, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        ...
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(1, pixels * 9, anchor='nw', image=self.obstacle3_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 10, pixels * 7, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(0, pixels * 5, anchor='nw', image=self.obstacle1_object)
        # Obstacle 16
        ...
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 3, pixels * 3, anchor='nw', image=self.obstacle2_object)
